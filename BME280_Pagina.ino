...
void handle_OnConnect() {
  ...
  server.send(200, "text/html", SendHTML(temperature,humidity,pressure,hic));
}
...
String SendHTML(float temperature,float humidity,float pressure,float hic){
